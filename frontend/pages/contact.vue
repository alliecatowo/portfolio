        ...
        <div class="space-y-6">
          ...
          <div v-if="siteConfig.type === 'tattoo'" class="flex items-start">
            ...
            <div>
              ...
              <p class="mt-1">
                <a v-if="siteConfig.socialLinks.instagram" :href="siteConfig.socialLinks.instagram" target="_blank" rel="noopener noreferrer" class="text-primary dark:text-primary-400">
