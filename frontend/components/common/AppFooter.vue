      ...
      <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
        ...
        <section aria-labelledby="footer-about">
          ...
          <nav class="flex space-x-4 mt-4" aria-label="Social media links">
            ...
            <UTooltip text="Connect on LinkedIn" :delay-duration="300">
              <a v-if="siteConfig?.socialLinks?.linkedin" :href="siteConfig.socialLinks.linkedin" target="_blank" rel="noopener noreferrer" class="text-gray-500 hover:text-primary dark:text-gray-400 dark:hover:text-primary-400">
            ...
            <UTooltip text="Follow on Twitter" :delay-duration="300">
              <a v-if="siteConfig?.socialLinks?.twitter" :href="siteConfig.socialLinks.twitter" target="_blank" rel="noopener noreferrer" class="text-gray-500 hover:text-primary dark:text-gray-400 dark:hover:text-primary-400">
            ...
            <UTooltip text="Follow on Instagram" :delay-duration="300">
              <a v-if="siteConfig?.socialLinks?.instagram" :href="siteConfig.socialLinks.instagram" target="_blank" rel="noopener noreferrer" class="text-gray-500 hover:text-primary dark:text-gray-400 dark:hover:text-primary-400">
            ...
            <UTooltip text="Send me an email" :delay-duration="300">
              <a v-if="siteConfig?.socialLinks?.email" :href="`mailto:${siteConfig.socialLinks.email}`" class="text-gray-500 hover:text-primary dark:text-gray-400 dark:hover:text-primary-400">
